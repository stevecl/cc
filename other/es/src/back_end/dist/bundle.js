(function (global, factory) {
    ...
    const controllersArray = []; // 装饰器对类的行为的改变，是代码编译时发生的，而不是运行时；
    // 所以，在之前就干了这么一件事
    ...
    let MovieController$1 = (_dec$1 = Controller('/movie'), _dec2$1 = RequestMapping(RequestMethod.GET, '/all'), _dec3 = RequestMapping(RequestMethod.GET), _dec$1(_class$1 = (_class2$1 = class MovieController {
    ...
    }, (_applyDecoratedDescriptor$1(_class2$1.prototype, "getAllMovies", [_dec2$1], Object.getOwnPropertyDescriptor(_class2$1.prototype, "getAllMovies"), _class2$1.prototype), _applyDecoratedDescriptor$1(_class2$1.prototype, "id", [_dec3], Object.getOwnPropertyDescriptor(_class2$1.prototype, "id"), _class2$1.prototype)), _class2$1)) || _class$1);
     // /movie/all

    var _dec, _dec2, _class, _class2;

    function _applyDecoratedDescriptor(target, property, decorators, descriptor, context) { var desc = {}; Object.keys(descriptor).forEach(function (key) { desc[key] = descriptor[key]; }); desc.enumerable = !!desc.enumerable; desc.configurable = !!desc.configurable; if ('value' in desc || desc.initializer) { desc.writable = true; } desc = decorators.slice().reverse().reduce(function (desc, decorator) { return decorator(target, property, desc) || desc; }, desc); if (context && desc.initializer !== void 0) { desc.value = desc.initializer ? desc.initializer.call(context) : void 0; desc.initializer = undefined; } if (desc.initializer === void 0) { Object.defineProperty(target, property, desc); desc = null; } return desc; }
    let MovieController = (_dec = Controller('/user'), _dec2 = RequestMapping(RequestMethod.GET, '/all'), _dec(_class = (_class2 = class MovieController {
      async getUser(ctx) {
        ctx.body = 'user';
      }
    ...
    var index = [MovieController$1, MovieController];

    const router = new Router__default["default"]();
    const app = new Koa__default["default"](); // cors 
