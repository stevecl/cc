export default class ESQiNiu {
  ...
  upload(filePath, success, fail, options, progress, cancelTask) {
    ...
    if (this.config.qiniuUploadToken) {
      this.doUpload(filePath, success, fail, options, progress, cancelTask);
    ...
    var uploadTask = uni.uploadFile({
      ...
      success: (res) => {
        ...
        try {
          ...
          // 拼接fileURL
          var fileURL = this.config.qiniuBucketURLPrefix + '/' + dataObject.key;
