...
<script>
	 ...
	 * @property {String} default-src 默认头像路径
	...
	export default {
		...
		data() {
			return {
                ...
                avatar: this.src ? this.src : this.defaultSrc ? this.defaultSrc : base64Avatar, 
			}
		},
        watch: {
            src(n) {
                ...
                if(!n) {
					...
					this.avatar = this.defaultSrc ? this.defaultSrc : base64Avatar;
					this.error = true;
				} else {
					this.avatar = n;
					this.error = false;
