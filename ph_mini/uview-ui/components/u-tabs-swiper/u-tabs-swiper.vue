	...
	<view class="u-tabs" :style="{
		...
		<scroll-view scroll-x class="u-scroll-view" :scroll-left="scrollLeft" scroll-with-animation
			...
			<view class="u-tabs-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
				<view class="u-tabs-item" :style="[tabItemStyle(index,item)]" v-for="(item, index) in getTabs"
		...
		computed: {
			...
			tabItemStyle() {
				return (index, item) => {
					...
					// 做了一个特殊扩展
					if (this.tabItemStyleKey) {
						style=Object.assign(style, item[this.tabItemStyleKey]);
					}
