...
const query = ref({
    ...
    pageSize: 10,
    searchKey: '',
    category: 'MEMBER_CENTER', // 页面分类(首页:HOME,惠生活:HSH,会员中心:MEMBER_CENTER,自定义页面:CUSTOM_PAGE,底部菜单:BOTTOM_MENU,启动广告:HOME_ADVERT)
    sourceType: 'MARKET_APPLETS'
  })

const handleAdd = () => {
  router.push({ name: 'edit', query: { type: 'MEMBER_CENTER', id: '' } })
}
