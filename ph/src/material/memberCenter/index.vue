<template>
  <div class="edit-module-member-center" :style="styleObj">
...
.edit-module-member-center {
  ...
  height: 300px;
  background: url('../../assets/images/member/bg_mine.png') 0 0 no-repeat;
  ...
  .score-info {
    position: relative;
    background: url('../../assets/images/member/bg_wallet.png') 0 0 no-repeat;
